...
(function (global, factory) {
   ...
   */
  var ELEMENT_NODE = 1; // 正常元素节点
  var TEXT_NODE = 3; // 文本节点
  var COMMENT_NODE = 8; // 注释节点
  var DOCUMENT_NODE = 9; // Document节点
  var DOCUMENT_FRAGMENT_NODE = 11; // DocumentFragment节点
  ...
  function extractEvents$4(dispatchQueue, topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, targetContainer) {
...

    {
      ...
      accumulateSinglePhaseListeners(targetInst, dispatchQueue, event, inCapturePhase);
    }
  ...
  function accumulateSinglePhaseListeners(targetFiber, dispatchQueue, event, inCapturePhase) {
